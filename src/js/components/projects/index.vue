    ...
    methods: {
      fetchProjects: function () {
        ...
        .then(function (response) {
          ...
          var chunk = _.chunk(res, this.pagination.perPage);
    ...
    <section class="packages">
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div v-bind:class="project_class"
            ...
            <div class="text-center">
                <nav>
                    <ul class="pagination">
                        ...
                        <li v-for="(index, pag) in pagination.pagesNumbers"
                            v-bind:class="{active:pagination.currentPage == pag}">
